...
import o1.adventure.SwiftAdventure
...
object SwiftAdventureGUI extends SimpleSwingApplication {
  ...
  def top = new MainFrame {
    ...
    this.contents = new GridBagPanel {
      ...
      layout += new Label("Action:") -> new Constraints(0, 0, 1, 1, 0, 1, NorthWest.id, Fill.None.id, new Insets(8, 5, 5, 5), 0, 0)
      layout += new Label("Command:") -> new Constraints(0, 1, 1, 1, 0, 0, NorthWest.id, Fill.None.id, new Insets(8, 5, 5, 5), 0, 0)
      layout += new Label("Narratives:") -> new Constraints(0, 2, 1, 1, 0, 0, NorthWest.id, Fill.None.id, new Insets(8, 5, 5, 5), 0, 0)
